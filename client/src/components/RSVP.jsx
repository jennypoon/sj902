      ...
      <div className="formContent">
        {this.state.rsvp ? (
          <div className="formSubmitted">
            ...
            <p>Got Questions?<br/>Email us at: <a href="mailto:stephenjenny2019@gmail.com?subject=Jenny and Stephen's 9.02 Wedding Inquiry">stephenjenny2019@gmail.com</a><br/>or call us at 604-716-7891</p>
          </div>
          ) : (
          <div>
